<template>
    <div id="page-5" class="page-common animation-page swiper-slide" data-brand-name="CBMC 한국대회 청년초청집회" data-brand-url="">
        <div class="page-common-inner" data-scrollbar>
            ...
            <div class="page-article">
                ...
                <div class="comment-block">
                    <div class="comment-block-inner">
                        ...
                        설문을 통하여 관련 부분별로 구분하여 코칭이 이루어지도록 팀 구성
                        <div style="margin-top: 10px;">각 팀의 코칭매칭이 필요</div>
                    </div>
                </div>
                <div class="spacer" style="height: 20px;"></div>
            </div>
            ...
            <div class="bottom-angle" data-animation data-animation-trigger="top"></div>
